...
from Back.Puxador_credito import puxador_credito


router = APIRouter(prefix="/puxador-credito")
...
@router.post("/")
async def post_credito(date_range: DateRange):
    
    result = await puxador_credito(date_range)
